...
public class HistoricalBHR {
    ...
    private static final Environment    environment = RetrofitFactory.Environment.LOCAL;

    //for dates
    private static final DateTimeHelper dtHelper    = new DateTimeHelper( TimeZones.America_NewYork,
            "MM/dd/YY HHmm 'hrs'", "M/d/YY HHmm 'hrs'", "M/dYY HHmm'hrs'", "MM/dd/YY HHmm 'hors'", "MM/dd/YY HHmm 'Hrs'", "MM/dd/YY HHmm 'hrs.'",
    ...
    private static final DateTimeHelper bdHelper    = new DateTimeHelper( TimeZones.America_NewYork,
            "MM/dd/YY" );
    //for times
    private static final JavaDateTimeHelper tHelper    = new JavaDateTimeHelper( TimeZones.America_NewYork,
            "MM/dd/YY HHmm 'hrs'", "M/d/YY HHmm 'hrs'", "M/ddYY HHmm 'hrs'", "M/dYY HHmm'hrs'", "M/d/YY HHmm 'hrs.'", "M/d/YY HHmm 'Hrs'", "M/d/YY HHmm", "M/d/YY HHmm 'HRS'",
    ...
    public static void main( String[] args ) throws InterruptedException {
        ...
        final String bhrMayPath = args[ 4 ];
        ...
        SimplePayload b3payload = new SimplePayload( bhrMayPath );
...
//                    .useCurrentSync()
        ...
        Flight bhrMayflight = Flight.newFlight()
                .createEntities()
...
//                    .useCurrentSync()
    ...
    //                .useCurrentSync()
                    .addProperty( "bhr.dateReported")
                        .value(  row -> dtHelper.parseDate( row.getAs( "bhr.dateReported" ) ) ).ok()
...
//                    .useCurrentSync()
    ...
    //                .useCurrentSync()
        ...
        flights.put( bhrMayflight, b3payload );
